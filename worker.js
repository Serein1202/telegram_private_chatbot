...
const SPAM_RULE_GROUPS = [
    ...
    { weight: 60, name: "兼职刷单/返利", keywords: ["刷单", "返利", "日入", "月入过万", "稳赚", "躺赚", "带你赚", "带单", "高额回报", "保本保息", "红包返现", "动动手指", "宝妈兼职", "闲鱼无货源"] },
    ...
    { weight: 60, name: "虚拟币/投资诈骗", keywords: ["usdt", "u商", "收u", "出u", "泰达币", "虚拟币", "挖矿收益", "交易所返佣", "老师带单", "内幕消息"] }
];
